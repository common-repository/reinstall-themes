...
Reinstall Themes will fix and remove the common WordPress limitation "destination already exists" and delete the targeted theme directory before installing the newer version. After that WordPress will take place and continue the regular installation or upgrade process.
